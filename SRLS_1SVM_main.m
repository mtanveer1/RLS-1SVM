...
for run=1:tot_run
    ...
    for ii = 1:length(C1)
        ...
        for iii = 1:length(C2)
            ...
            for t = 1:length(Sigma)
                ...
                %% training
                [PCP,alpha,rho,train_time,base_time]=SRLS_1SVM_func(traindata,FunPara.kerfpara,redu_no,1e-10,FunPara.c_1,FunPara.c_2,1,seed1 );
                [labeltr_OCLSSVM,theta_train] = test_model1_SRLS_1SVM(traindata,traindata,alpha,rho,FunPara,PCP);
                labelval_OCLSSVM = test_model2_SRLS_1SVM(valdata,traindata,alpha,rho,FunPara,theta_train,PCP);
    ...
    %% testing
    [PCP,alpha,rho]=SRLS_1SVM_func(traindata,Funpara.kerfpara,redu_no,1e-10,Funpara.c_1,FunPara.c_2,1,2 );
    [label_OCLSSVM,testing_time] = test_model3_SRLS_1SVM(testdata,traindata,alpha,rho,Funpara,PCP);
